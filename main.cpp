...
//    std::cout << lruCacheObj2.getMostRecentKey() << "\n";    // 'c'
//    std::cout << lruCacheObj2.getValueFromKey('a') << "\n";   // return 1
//    std::cout << lruCacheObj2.getMostRecentKey() << "\n";    // 'a'
//    lruCacheObj2.insertKeyValuePair('d', '4');     // cache maxSize reached; delete lru and update
//    std::cout << lruCacheObj2.getValueFromKey('b') << "\n";   //  return -1, 'b' was evicted in the previous operation
//    lruCacheObj2.insertKeyValuePair('a', '5'); // 'a' already exist; update value and position
//    std::cout << lruCacheObj2.getValueFromKey('a') << "\n";  // return 5
    return 0;
}
